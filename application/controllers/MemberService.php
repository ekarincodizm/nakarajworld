...
class MemberService extends REST_Controller
{
	...
	public function AccountDetailExtend_post()
	{
		$input =  $this->post();
		//print_r($input);
		$AccountDetailExtend = $this->AccountModel->JounalExtend($input['account_id']);
		// print_r($AccountDetailExtend);
	...
	public function AddAccountDetailExtend_post()
	{
		...
		$this->response( array('AccountDetailExtend' => $AccountDetailExtend,'accounting_id' => $returnAccounting_id ));
	}
