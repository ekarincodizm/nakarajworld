...
$this->debuger->front_load_js('owl.carousel.min');
$this->debuger->front_load_js('waypoints.min');
$this->debuger->front_load_js('jquery.counterup.min');
$this->debuger->front_load_js('scripts');
