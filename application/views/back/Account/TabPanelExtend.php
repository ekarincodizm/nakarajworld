...
<div class="row" ng-controller="PanelExtendCtrl">
  <div class="col-md-12" style="padding:20px" >
    ...
    <button ng-if="LastListExtend.journal_extend_expired_date < date_now" type="button" class="btn bg-deep-orange" ng-click="MemberExtend(<?php echo $Profile[0]['member_id'] ?>);">
      ต่ออายุ
    </button>
          ...
          <tr ng-repeat="row in ListExtend">
            ...
            <td>
              <a ng-if="row.accounting_status == 1" target="_blank" href="<?php echo site_url('/AccountController/PrintAccountInvoice/'.'{{row.journal_extend_id}}'); ?>"
                ...
                <span ng-if="row.accounting_status == 0" class="label bg-blue-grey">รอดำเนินการ</span>
                </td>
              </tr>
            </tbody>
          </table>
