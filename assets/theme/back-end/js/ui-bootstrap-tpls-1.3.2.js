...
.controller('UibCarouselController', ['$scope', '$element', '$interval', '$timeout', '$animate', function($scope, $element, $interval, $timeout, $animate) {
  ...
  self.next = $scope.next = function() {
    ...
    return self.select(slides[newIndex], 'ถัดไป');
  };
  ...
  self.prev = $scope.prev = function() {
    ...
    return self.select(slides[newIndex], 'หน้าก่อน');
  };
  ...
  self.select = $scope.select = function(nextSlide, direction) {
    ...
    if (direction === undefined) {
      direction = nextIndex > self.getCurrentIndex() ? 'ถัดไป' : 'หน้าก่อน';
    }
      ...
      $animate.on('addClass', slides[index].element, function(element, phase) {
        if (phase === 'close') {
          ...
          if (bufferedTransitions.length) {
            ...
            var nextDirection = nextIndex > self.getCurrentIndex() ? 'next' : 'หน้าก่อน';
            clearBufferedTransitions();
